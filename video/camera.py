...
class Main:
    def __init__(self):
        ...
        self.pipeline.add_many(self.videosrc, self.vfilter,  self.enc, self.mux, self.queue, self.tcpsink)
        gst.element_link_many(self.videosrc, self.vfilter,  self.enc, self.mux, self.queue, self.tcpsink)
